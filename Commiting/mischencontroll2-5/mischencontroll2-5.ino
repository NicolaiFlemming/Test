...
void loop()
{
    if (phase == 0) //Phase 0
    {
        do
        {
            ...
            lcd.print("Benutzer1/Benutzer2");   //Auf LCD-Bildschirm schreiben

            if (digitalRead(But2) == HIGH)      //Benutzer1 und Phasenwechsel
            {
                phase = 1;
                delay(1000);
            }
            if (digitalRead(But3) == HIGH)      //Benutzer2 Phasenwechsel
            {
                phase = 1;
                delay(1000);
            }

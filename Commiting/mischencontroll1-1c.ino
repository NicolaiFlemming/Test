...
void loop()
{
    ...
    Serial.print("Liest:  ");
    Serial.print(scale.get_units(), 3); //Schreibt Gewicht auf den seriellen Monitor
    Serial.print(" kg");
    Serial.print(" Kalibrierungsfaktor");
    Serial.print(calibration_factor);   //Schreibt Kalibrierungsfaktor auf den seriellen Monitor
    Serial.println();
    ...
    if (Serial.available())
    {
        ...
        if (temp == '+' || temp == 'a')
            ...
            scale.tare(); //bei t tarieren          //if Schleife um den Kalibrierungsfaktor um jeweils den angegeben Wert zu ändern
    }
}
//=============================================================================================

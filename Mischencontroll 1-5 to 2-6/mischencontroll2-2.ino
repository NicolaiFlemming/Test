...
void setup() {
  ...
  pinMode (But1, INPUT);      //Definieren des Pins als Analog Input 8Bit
...
void loop()
{
    if(phase == 0)          //Auswahl Benutzerauswahl oder -erstellung
    {
        ...
        lcd.print("auswaehlen/erstellen");   //Auf LCD-Bildschirm schreiben
        ...
        while(phase == 2)
        {
            ...
            else
            {
                ...
                {                    
                    lcd.clear();
                    lcd.setCursor(0,0);                                 //Definieren wo auf LCD-Bildschirm Geschrieben wird (Stelle, Zeile)
                    lcd.print("Geschlecht auswaehlen:");                 //Auf LCD-Bildschirm schreiben
                    lcd.setCursor(0,1);                                 //Definieren wo auf LCD-Bildschirm Geschrieben wird (Stelle, Zeile)
                    lcd.print("Maennlich/Weiblich");                     //Auf LCD-Bildschirm schreiben 

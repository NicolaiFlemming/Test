 ...
 //====================================================================================================================================================
    ...
    if(phase == 3)                                                              //Einschenkvorgang  
    {
        do                                                                      //check = false btn = false
        {
            ...
            weightP = shortit(scale.get_units())*1000;                          //Einholen der Werte von der Waage und Umwandlung in Gramm
            ...
            else                                                                //Alles was passieren soll bevor der Knopf gedrückt wird
            {
                ...
                VolGes = volCalc(constrain(analogRead(Pot2), 0 , 1023));        //Umwandeln vom Potentiometer-Input in gewünschtes Volumes
